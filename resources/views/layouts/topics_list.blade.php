<li class="topic-item">
               ...
               @endphp   
                <p class="topic-info">By <a href="/forums/profile/{{ $topic->author_id }}">{{ $author->username }}</a>, <time datetime="{{ $topic->created_at }}">{{ \Carbon\Carbon::parse($date)->format('M j, Y') }}</time></p>
</li>